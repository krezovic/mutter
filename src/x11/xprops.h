 ...
 */
gboolean meta_prop_get_motif_hints   (MetaX11Display   *display,
                                      Window            xwindow,
                                      Atom              xatom,
                                      MotifWmHints    **hints_p);
gboolean meta_prop_get_cardinal_list (MetaX11Display   *display,
                                      Window            xwindow,
                                      Atom              xatom,
                                      uint32_t        **cardinals_p,
                                      int              *n_cardinals_p);
gboolean meta_prop_get_latin1_string (MetaX11Display   *display,
                                      Window            xwindow,
                                      Atom              xatom,
                                      char            **str_p);
gboolean meta_prop_get_utf8_list     (MetaX11Display   *display,
                                      Window            xwindow,
                                      Atom              xatom,
                                      char           ***str_p,
                                      int              *n_str_p);
void     meta_prop_set_utf8_string_hint
                                     (MetaX11Display *display,
                                      ...
                                      Atom atom,
                                      const char *val);
gboolean meta_prop_get_window        (MetaX11Display *display,
                                      Window          xwindow,
                                      Atom            xatom,
                                      Window         *window_p);
gboolean meta_prop_get_cardinal      (MetaX11Display *display,
                                      Window          xwindow,
                                      Atom            xatom,
                                      uint32_t       *cardinal_p);
gboolean meta_prop_get_cardinal_with_atom_type (MetaX11Display *display,
                                                Window          xwindow,
                                                Atom            xatom,
                                                Atom            prop_type,
                                                uint32_t       *cardinal_p);
 ...
 * is filled in.
 */
void meta_prop_get_values (MetaX11Display   *display,
                           Window            xwindow,
