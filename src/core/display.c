...
void
meta_display_reload_cursor (MetaDisplay *display, gboolean reload_x11_cursor)
{
  ...
  if (reload_x11_cursor)
    meta_x11_display_reload_cursor (display->x11_display);
}
                         ...
                         MetaCursor   cursor)
{
  ...
  gboolean reload_x11_cursor = FALSE;
  if (display->x11_display)
    reload_x11_cursor = TRUE;

  display->current_cursor = cursor;
  meta_display_reload_cursor (display, reload_x11_cursor);
}
                        ...
                        void          *data)
{
  ...
  if (pref == META_PREF_AUDIBLE_BELL)
    ...
    {
      meta_display_reload_cursor (display, FALSE);
    }
