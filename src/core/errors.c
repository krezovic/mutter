...
{
  gdk_x11_display_error_trap_push (x11_display->gdisplay);
}

void
meta_error_trap_pop (MetaX11Display *x11_display)
{
  gdk_x11_display_error_trap_pop_ignored (x11_display->gdisplay);
}

int
meta_error_trap_pop_with_return (MetaX11Display *x11_display)
{
  return gdk_x11_display_error_trap_pop (x11_display->gdisplay);
}
