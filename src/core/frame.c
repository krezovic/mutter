...
meta_window_ensure_frame (MetaWindow *window)
{
  ...
  frame->ui_frame = meta_ui_create_frame (window->display->x11_display->ui,
                                          XDISPLAY(window),
                                          frame->window,
                                          window->xvisual,
                                          frame->rect.x,
  ...
  meta_ui_map_frame (frame->window->display->x11_display->ui, frame->xwindow);
